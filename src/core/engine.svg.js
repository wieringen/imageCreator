...
function( config, cache )
{
    ...
    module.initialize = function()
    {
        ...
        svgSelect.setAttribute( "style", "fill: transparent; stroke-dasharray: 5,5; stroke:#666;" );
        ...
        $.subscribe( "layerEdit.engine", svgLayerEdit );        
        ...
        $( svgSelect ).bind( "tap", svgLayerTapEdit );
    ...
    function svgLayerTapEdit( event )
    {
    ...
    {
        cache.setLayerActiveByID( this.id.replace( module.name, "" ) );
    }
