 ...
 */
 ;( function( $, context, appName )
 {
    ...
    vml.initialize = function()
    {
        ...
        //
        var vmlSelect = "<rvml:rect id='vmlSelect' strokecolor='#ccc' strokeweight='2px' style='position: absolute;'><rvml:fill opacity='0' /><rvml:stroke dashstyle='dash'/></rvml:rect>";
    ...
    function vmlDraw( event, layer )
    {
       ...
       ;
        ...
        vmlSelect.style.setAttribute('height',layer.sizeCurrent.height +6);
        vmlSelect.style.setAttribute('width',layer.sizeCurrent.width +6); 
        vmlSelect.style.setAttribute( "top", (layer.position.y -3 )+ "px" );
        vmlSelect.style.setAttribute( "left", (layer.position.x -3 )+ "px" );
