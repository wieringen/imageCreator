;(function ( $, window, document, undefined )
{
    ...
    {   
		...
		setPosition: function( event, degrees )
		{
			...
			this.$degrees.html( sanitizedDegrees );

			this.$thumb.css(  "top", Math.round( -Math.cos( sanitizedDegrees * ( Math.PI / 180 ) ) * 30 +42 ) );
			this.$thumb.css( "left", Math.round(  Math.sin( sanitizedDegrees * ( Math.PI / 180 ) ) * 30 +42 ) );			
		},
		...
		drag: function( event )
		{
			...
			this.$degrees.html( degrees );

			this.$thumb.css(  "top", Math.round( -Math.cos( angle ) * 30 +42 ) );
			this.$thumb.css( "left", Math.round(  Math.sin( angle ) * 30 +42 ) );
